...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 27, 2023 at 11:10 AM
...
(555, 1, '4:33:22 PM', '', 'Time-in recorded', '', '', '2023-08-27');
...
INSERT INTO `users` (`id`, `role_id`, `bio_data`, `fname`, `mname`, `lname`, `address`, `contact_num`, `email`, `status`, `teaching`, `password`, `remember_token`, `created_at`, `updated_at`, `deleted_at`) VALUES
(1, 1, '123', 'Francis', 'De Leon', 'Caraang', '', '', '', 'active', 'no', '', NULL, NULL, NULL, NULL),
(7, 4, '1234', 'Ralph', 'Dojo', 'Villanueva', 'asdfa', 'afds', 'asdfsa@g', 'inactive', 'no', '', NULL, NULL, NULL, NULL),
(13, 4, 'Jerome', 'jEROME', 'fad', 'DGS', 'SFD', '234', 'GSDF@', 'active', 'no', '', NULL, NULL, NULL, NULL),
...
(31, 54, 15, 'Grade 11', 11, NULL, NULL, NULL),
(32, 56, 15, 'Grade 12', 12, NULL, NULL, NULL);
