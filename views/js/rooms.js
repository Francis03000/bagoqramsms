$(document).ready(function () {
  ...
  function getAllData() {
    ...
    $.get({
      ...
      success: function (data) {
        ...
        newData.forEach((rooms, i) => {
          sampleArray.push(rooms);
          let tableRow = $("<tr>", { id: newData.id });
          $("<td>", { class: "text-wrap", html: i + 1 }).appendTo(tableRow);
          $("<td>", {
            class: "text-wrap",
            html: rooms.room_number,
          }).appendTo(tableRow);
          $("<td>", {
            class: "text-wrap",
            html: rooms.room_name,
          }).appendTo(tableRow);
  ...
  function update(index) {
    $("#modalMain").modal("show");
    $("#modalMainLabel").html("Update Room");
