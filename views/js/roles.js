$(document).ready(function () {
  ...
  function update(index) {
    $("#modalMain").modal("show");
    $("#modalMainLabel").html("Update Roles");
  ...
  function view(index) {
    $("#modalMain").modal("show");
    $("#modalMainLabel").html("View Roles");
    let models = sampleArray[index];
    Object.keys(models).map((key) => {
