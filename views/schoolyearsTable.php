    ...
    <div class="page-wrapper">
        <div class="content container-fluid" id="container_color">
            <!-- <div class="page-header">
                <div class="row">
                    <div class="col-md-6">
                        <h3 class="page-title mb-0">School Year</h3>
                    </div>
                    <div class="col-md-6">
            ...
            <div class="card" style="margin-top:2%;">
                <div class="card-header">
                    <div class="row">
                        <div class="col">
                            <h5 class="table-header-color page-title mb-0">School Year List</h5>
                        </div>
                        <div class="col">
                ...
                <div class="card-body">
                    ...
                    <?php include('modals/schoolyearsModal.php'); ?>
                </div>
            </div>
        </div>
    </div>
</div>
<script src="js/schoolyears.js"></script>
